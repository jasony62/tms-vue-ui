...
function getRawCreateArgs(field) {
  ...
  var args = field.component ? customComponent : field.hasOwnProperty('items') && field.type !== 'select' ? _node.components["".concat(field.type, "group")] || defaultGroup : _node.components[field.type] || defaultInput;
  return args;
}
/**
 * 表单中的模型属性节点包含value
