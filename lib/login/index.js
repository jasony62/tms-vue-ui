...
var Login = {
  install: function install(Vue, options) {
    var fnGetCaptcha = options.fnGetCaptcha,
        fnGetToken = options.fnGetToken;
    var Plugin = Login.plugin();
    var login = new Plugin(fnGetCaptcha, fnGetToken);
  ...
  plugin: function plugin() {
    ...
    /*#__PURE__*/
    function () {
      function Plugin(fnCaptcha, fnToken) {
            ...
            methods: {
              ...
              login: function login() {
                ...
                fnToken(loginData).then(function (response) {
                  ...
                  if (_this.asDialog) {
                    _this.asDialog = false;

                    _this.$emit('success', result.access_token);
                  }

                  _this.onSuccess(result.access_token);
                });
              },
              ...
              showDialog: function showDialog(data, onSuccess, onFail) {
                var _this2 = this;
